    ...
    QGLWidget(parent)
{
    ...
    char text[]= "../qtOpenGl_SHPlib/assets/5. Roads/Roads.shp";

    OpenShapeFile("../qtOpenGl_SHPlib/assets/Polygons/polygons.shp");//Point Shapefile
    OpenShapeFile("../qtOpenGl_SHPlib/assets/allMapSHP/all_shp.shp");//Polygon Shapefile
