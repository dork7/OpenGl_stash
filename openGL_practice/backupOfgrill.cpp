...
GLfloat gfPosY2 = 1.0;
//base
GLfloat leftToRightX = -1.0;
GLfloat leftToRightY = 0.0;
//moving
GLfloat gfPosX3 = -1.0;
GLfloat gfPosY3 = 0.0;
...
void render(void)
{
    ...
    glVertex2f(leftToRightX, leftToRightY);
    glVertex2f(gfPosX3, gfPosY3);
...
int main(int agrc, char **argv)
{
    ...
    glutTimerFunc(200, timer, 0); // 0 is the interger to pass it to the function // this will call the timer function periodically
