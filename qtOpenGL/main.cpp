...
int main(int argc, char *argv[])
{
    ...
    //    init();
    //    glutMainLoop(); // take care of the program life cycle or interactions


    QApplication a(argc, argv);
    Display display(800, 600 , "openGL"); // call this first xD no matter what
...
//    Shader shader("/home/hamza/Pictures/qtOpenGL/res/shader");
    ...
    Texture texture("/home/hamza/Pictures/round-triangle-pyramid-eye-illuminati-512.png");
